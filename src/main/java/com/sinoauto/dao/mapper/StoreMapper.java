...
public interface StoreMapper {
	...
	@Select("select us.user_name as userName,sto.store_name as storeName,sto.address,sto.mobile as stoMobile,us.mobile as userMobile,sto.back_url as backUrl,sto.store_id as storeId,"
			+ " sto.is_useable as isUseable,us.user_id as userId,"
			...
			+ " sto.county_id as countyId,sto.county_name as countyName , CASE sto.store_level when 1 then 'A' when 2 then 'B' when 3 then 'C' when 4 then 'D' ELSE '' END as storeLevel,CASE sto.store_class when 1 then '加盟' when 2 then '直营'  ELSE '' END as storeClass "
