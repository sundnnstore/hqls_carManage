...
public interface RebateMapper {
	...
	@Select("select sum(rebate_money) from hqls_rebate where store_id = #{storeId} group by is_rebate order by is_rebate;")
	public Double[] getRebateMoney(@Param("storeId") Integer storeId);
